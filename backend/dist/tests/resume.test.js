...
const auth_middleware_1 = require("../middleware/auth.middleware"); // Import to mock
// --- Mock Dependencies ---
...
describe('POST /api/resumes/upload', () => {
    beforeEach(() => {
        ...
        auth_middleware_1.authenticateToken.mockImplementation((req, res, next) => {
            req.user = { uid: 'test-user-id-456', email: 'authed@example.com' };
            next();
        });
    ...
    it('should upload, parse, and save a PDF file successfully', async () => {
        ...
        expect(auth_middleware_1.authenticateToken).toHaveBeenCalledTimes(1); // Verify auth middleware was called
    ...
    it('should upload, parse, and save a DOCX file successfully', async () => {
        ...
        expect(auth_middleware_1.authenticateToken).toHaveBeenCalledTimes(1);
    ...
    it('should return 401 if user is not authenticated', async () => {
        ...
        auth_middleware_1.authenticateToken.mockImplementation((req, res, _next) => {
    ...
    it('should return 400 if no file is uploaded', async () => {
        ...
        expect(auth_middleware_1.authenticateToken).toHaveBeenCalledTimes(1); // Auth runs first
