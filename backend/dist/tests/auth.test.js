...
describe('POST /api/auth/signup', () => {
    ...
    it('should return 400 if required fields are missing', async () => {
        ...
        const response = await (0, supertest_1.default)(server_1.default).post('/api/auth/signup').send(incompleteData);
    ...
    it('should return 409 if email already exists', async () => {
        ...
        const response = await (0, supertest_1.default)(server_1.default).post('/api/auth/signup').send(userData);
